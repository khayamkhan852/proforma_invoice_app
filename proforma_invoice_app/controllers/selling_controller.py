...
from alwedyan_custom_app.controllers.accounts_controller import get_taxes_and_charges
from alwedyan_custom_app.controllers.sales_and_purchase_return import get_rate_for_return
from alwedyan_custom_app.controllers.stock_controller import StockController
...
class SellingController(StockController):
	...
	def onload(self):
		super().onload()
		if self.doctype in ("Sales Order", "Delivery Note", "Sales Invoice", "Proforma Invoice"):

		...
		if (frm.doc.docstatus === 0) {
			...
			if (frm.doc.docstatus === 0) {
				frappe.call({
                    ...
                    method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.get_stock_reservation_status",
					callback: function (r) {
						if (!r.message) {
...
erpnext.selling.SalesOrderController = class SalesOrderController extends erpnext.selling.SellingController {
	...
	create_pick_list() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.create_pick_list",
			frm: this.frm,
		});
	}
	...
	make_work_order() {
		var me = this;
		me.frm.call({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.get_work_order_items",
			args: {
	...
	make_material_request() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_material_request",
			frm: this.frm,
		});
	}
	...
	make_raw_material_request_dialog(r) {
		...
		var d = new frappe.ui.Dialog({
			...
			primary_action: function () {
				...
				me.frm.call({
                    method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_raw_material_request",
					args: {
						items: data,
						company: me.frm.doc.company,
						proforma_invoice: me.frm.docname,
	...
	make_delivery_note(delivery_dates, for_reserved_stock = false) {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_delivery_note",
			frm: this.frm,
			args: {
				delivery_dates,
	...
	make_sales_invoice() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_sales_invoice",
			frm: this.frm,
		});
	}
	...
	make_maintenance_schedule() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_maintenance_schedule",
			frm: this.frm,
		});
	}
	...
	make_project() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_project",
			frm: this.frm,
		});
	}
	...
	make_inter_company_order() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_inter_company_purchase_order",
			frm: this.frm,
		});
	}
	...
	make_maintenance_visit() {
		frappe.model.open_mapped_doc({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.make_maintenance_visit",
			frm: this.frm,
		});
	}
		...
		var dialog = new frappe.ui.Dialog({
			...
			primary_action(args) {
				...
				var method = args.against_default_supplier
					...
					: "make_purchase_order";
				return frappe.call({
                    method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice." + method,
	...
	update_status(label, status) {
		...
		frappe.call({
            method: "proforma_invoice_app.proforma_invoice_app.doctype.proforma_invoice.proforma_invoice.update_status",
